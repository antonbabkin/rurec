...
```{r}
source("R/trade_flows.R", local = (tf <- new.env()))
x <- tf$call_trade_flows("335222")
```


## issues

A few industries, notably "1111A0" (oilseed) and "112120" (dairy), fail to solve. Returned trade flows are all zero. Need to investigate.
