...
# source("R/basic_utilities.R", local = (util <- new.env()))
# util$zip_pack("tmp/infogroup_county_agg_v240220_.zip", ig$opath$county_)
# util$zip_unpack("tmp/infogroup_county_agg_v240220_.zip", overwrite = TRUE)
...
# solve for single industry industry
x <- tf$call_trade_flows("336414")
...
# packing and unpacking county aggregates (uncomment as needs)
# source("R/basic_utilities.R", local = (util <- new.env()))
# util$zip_pack("tmp/trade_flows_v240221.zip", tf$opath$flows_)
# util$zip_unpack("tmp/trade_flows_v240221.zip", overwrite = TRUE)
```
