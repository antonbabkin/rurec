...
In this 2-stage analysis, the counties of Wisconsin are first matched internally. Metro counties in areas with a population of 1 million or more (RUC  Code: 1) serve as first-order cores which all other counties are matched based on their capacitance.  
