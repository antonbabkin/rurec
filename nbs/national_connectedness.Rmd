...
Normalized Max Absorption (row-wise max ECA matching), 2012 BEA industry structure at detail level, 2012 CBP and farm sales data, 2013 TIGER county structure
```{r}
print(Sys.time())
...
Non-normalized Max Absorption (row-wise max ECA matching), 2012 BEA industry structure at detail level, 2012 CBP and farm sales data, 2013 TIGER county structure
```{r}
print(Sys.time())
df <- spatial_connectedness(cbp_year = "2012", 
                            ilevel = "det", 
...
Population adjusted non-normalized Total Absorption (row-wise max ECA matching), 2012 BEA industry structure at detail level, 2012 CBP and farm sales data, 2013 TIGER county structure
```{r}
...
```
 ...
 Absorption Gini (inequality/concentration) (row-wise max ECA matching), 2012 BEA industry structure at detail level, 2012 CBP and farm sales data, 2013 TIGER county structure
...
Normalized Absorption, 2012 BEA industry structure at detail level, 2012 CBP and farm sales data, 2013 TIGER county structure
``` {r}
