...
non_rural <- filter(TIGER_QCEW_RUCC, H3!=3) %>% transmute(place = place)  
st_geometry(non_rural) <- NULL
non_rural <- rownames(non_rural)

primary <- filter(TIGER_QCEW_RUCC, H3!=0) %>% transmute(place = place) %>% as.vector()
st_geometry(primary) <- NULL
primary <- rownames(primary)

Sim <- Sim_mat_exp_rel[[lvl]][rural, primary] / Q_mat[rural, primary] 
...
primary <- filter(TIGER_QCEW_RUCC, H3!=1 & STATEFP!="15" & STATEFP!="02") %>% transmute(place = place) %>% as.vector()
st_geometry(primary) <- NULL
primary <- rownames(primary)


Sim <- Sim_mat[[lvl]][rural, primary] / Q_mat[rural, primary] 
...
non_rural <- filter(TIGER_QCEW_RUCC, H3==1 & STATEFP!="15" & STATEFP!="02") %>% transmute(place = place)  
st_geometry(non_rural) <- NULL
non_rural <- rownames(non_rural)
...
rural <- filter(TIGER_QCEW_RUCC, RUCC_2013!=1 & STATEFP!="15" & STATEFP!="02") %>% transmute(place = place)  
st_geometry(rural) <- NULL
rural <- rownames(rural)

primary <- filter(TIGER_QCEW_RUCC, RUCC_2013==1 & STATEFP!="15" & STATEFP!="02") %>% transmute(place = place) %>% as.vector()
st_geometry(primary) <- NULL
primary <- rownames(primary)
...
length(unique(TIGER_QCEW_RUCC_h1m$match))
...
```{r}
Sim <- Sim_mat_rel[[lvl]][rural, primary] / Q_mat[rural, primary]
...
```{r}
Sim <- Sim_mat_imp[[lvl]][rural, primary] / Q_mat[rural, primary]
...
```{r}
Sim <- Sim_mat_exp[[lvl]][rural, primary] / Q_mat[rural, primary]
...
```{r}
Sim <- Sim_mat_imp_rel[[lvl]][rural, primary] / Q_mat[rural, primary]
