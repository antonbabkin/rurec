...
## Choose Sector level (1) or Summary level (2) 
lvl = 1
...
```{r}
WItest_rural <- grep("^55", colnames(Xpay_mat[[lvl]]), value=TRUE) %>%
...
WISim <- Sim_mat[[lvl]][WItest_rural, WItest_primary] / Q_mat[WItest_rural, WItest_primary] 
...
WISim <- Sim_mat_rel[[lvl]][WItest_rural, WItest_primary] / Q_mat[WItest_rural, WItest_primary] 
...
WISim <- Sim_mat_imp[[lvl]][WItest_rural, WItest_primary]  / Q_mat[WItest_rural, WItest_primary] 
...
WISim <- Sim_mat_exp[[lvl]][WItest_rural, WItest_primary] / Q_mat[WItest_rural, WItest_primary] 
...
WISim <- Sim_mat_imp_rel[[lvl]][WItest_rural, WItest_primary] / Q_mat[WItest_rural, WItest_primary] 
...
WISim <- Sim_mat_exp_rel[[lvl]][WItest_rural, WItest_primary] / Q_mat[WItest_rural, WItest_primary] 
...
WItest_primary <- c(grep("^55", colnames(Xpay_mat[[lvl]]), value=TRUE) , "17031", "27053")
names(WItest_primary) <- WItest_primary
...
TIGER_CBP_RUCC_h1m <- inner_join(TIGER_CBP_RUCC, RowMin, by = "place", copy = TRUE) %>% mutate(match_name = with(TIGER_CBP_RUCC_h1m, County_Name[match(match, place)]), .after = match)

test <- TIGER_CBP_RUCC_h1m
...
```{r}
  tmap_mode("view")
clust_name <- unique(TIGER_CBP_RUCC_h1m$match_name)
TIGER_CBP_RUCC_h1m %>% 
  tm_shape() +
  tm_fill(col = "match",
          ...
          id = "NAMELSAD", 
          palette = "Dark2",
          labels = c("Cook County", "Hennepin County",  "Brown County",     "Dane County",      "Milwaukee County", "Kenosha County"  ) ) +
  tm_borders(lwd = .5)        
