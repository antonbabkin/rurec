...
colnames(QCEW_2020_Sum_XBEA) <- sort(unique(QCEW_2020_Sum$naics))  %>% paste0("///")
...
colnames(CBP_2019_Sector_XBEA) <- sort(unique(CBP_2019_Sector$naics))
...
colnames(CBP_2019_Detail_XBEA) <- sort(unique(CBP_2019_Detail$naics))
...
# add augmented hierarchical classification s
