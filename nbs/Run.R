...
save(list = c("Sim_list", "TIGER_RUCC", "Direct_mat", "Total_mat", "Xpay_mat", "Sim_mat",  "Sim_mat_rel", "Sim_mat_imp", "Sim_mat_imp_rel", "Sim_mat_exp", "Sim_mat_exp_rel", "Q_mat", "Dist_mat"), file="nbs/Data.RData")
