...
```{r}
setwd("C:/Users/saraa/OneDrive - UW-Madison/USDA Research/Fall 2023/Data")
...
ruccdata <- read.csv("ANA_ruralurbancodes2013.csv")
netmigdata <- read.csv("ANA_NME_1020_75up_data_beta1.csv")
#LE2012_data<- read.csv("ANA_IHME 2012 Life Expectancy.csv")
#LE2017_data <- read.csv("ANA_IHME 2017 Life Expectancy.csv")
conn_growth_analysis <- read.csv("conn_growth_analysis.csv")
#CHRR_2012 <- read.csv("ANA_2012_CHRR_data.csv")
CHRR_2017 <- read.csv ("ANA_2017_CHRR_data.csv")
CHRR_2019 <- read.csv ("ANA_2019_CHRR_data.csv")
#CHRR_2020 <- read.csv ("ANA_2020_CHRR_data.csv")
