...
titles = c("Premature Mortality Rate", "Economic Resource Retention", "Racial Opportunity Gap", "Prosperity", "%\n Manufacturing", 
           "%\n Agriculture", 
           "Labor \nForce\n Participation Rate", "% \nOver 65", 
           "% \nBachelors Plus", "Poverty\n Rate", "Income \nRate", 
           "Log\n Population", "Uninsured \n Rate \nUnder 65")
...
paam_plot <- ggplot(data[!is.na(data[["four_metro"]]), ],
                    aes(x = paam, group = four_metro, color = as.factor(four_metro))) +
...
my_palette <- colorRampPalette(c("#8A1B47", "#888888ff"))(6)
 ...
 titles = c("Race-specific Premature Mortality", "Premature\n Mortality", "Retention", "Racial Opportunity Gap", "Prosperity", "%\n Manufacturing", "%\n Agriculture", "% FIRE", "% Edu and Med", "Labor \nForce\n Participation Rate", "% \nOver 65", "% \nBachelors Plus", "Poverty\n Rate", "Income \nRate", "Log\n Population", "Uninsured \n Rate \nUnder 65", "Metro & Nonmetro \n Counties")
