...
xwalk = read.csv("data/RRG_dataa/czlma903.csv") %>%
...
ols1a2 = lm(data = mi1, rrm_gap ~ pct_ag + pct_mine + pct_mfg + logpop + metro)
ols1a2_FE = lm(data = mi1, rrm_gap ~ pct_ag + pct_mine + pct_mfg + state_fe + logpop + metro)
...
```{r}
ols2a = lm(data = mi1, prosperity ~ retention + rrm_gap + pct_ag + pct_mine + pct_mfg + logpop + metro)
...
```{r}
ols2a_FE = lm(data = mi1, prosperity ~ retention + rrm_gap + pct_ag + pct_mine + pct_mfg + state_fe + logpop + metro)
...
```{r}
ols2ai = lm(data = mi1, prosperity ~ retention + rrm_gap + retention*rrm_gap + pct_ag + pct_mine + pct_mfg + logpop + metro)
...
```{r}
ols2ai_FE = lm(data = mi1, prosperity ~ retention + rrm_gap + retention*rrm_gap + pct_ag + pct_mine + pct_mfg + state_fe + logpop + metro)
...
ols3a = lm(data = mi1, paam ~ retention + rrm_gap + pct_ag + pct_mine + pct_mfg + prosperity + age + logpop + uninsured)
...
ols3a_FE = lm(data = mi1, paam ~ retention + rrm_gap + pct_ag + pct_mine + pct_mfg + prosperity + state_fe + age + logpop + uninsured)
...
ols3ai = lm(data = mi1, paam ~ retention + rrm_gap + retention*rrm_gap + pct_ag + pct_mine + pct_mfg + prosperity +  age + logpop + uninsured)
...
ols3ai_FE = lm(data = mi1, paam ~ retention + rrm_gap + retention*rrm_gap + pct_ag + pct_mine + pct_mfg + prosperity + state_fe + age + logpop + uninsured)
...
SE1a1 = errorsarlm(data = mi1, retention ~ pct_ag + pct_mine + pct_mfg + logpop + metro,
                  lw, zero.policy = TRUE)
SE1a2 = errorsarlm(data = mi1, rrm_gap ~ pct_ag + pct_mine + pct_mfg + logpop + metro,
                  lw, zero.policy = TRUE)
...
## not interaction
SE2a = errorsarlm(data = mi1, prosperity ~ retention + rrm_gap + pct_ag + pct_mine + pct_mfg + logpop,
                  lw, zero.policy = TRUE)
...
SE2ai = errorsarlm(data = mi1, prosperity ~ retention + rrm_gap + retention*rrm_gap + pct_ag + pct_mine + pct_mfg + logpop,
                  lw, zero.policy = TRUE)
...
SE3a = errorsarlm(data = mi1, paam ~ retention + rrm_gap + pct_ag + pct_mine + pct_mfg + prosperity + age + logpop + uninsured,
                  lw, zero.policy = TRUE)
...
SE3ai = errorsarlm(data = mi1, paam ~ retention + rrm_gap + retention*rrm_gap + pct_ag + pct_mine + pct_mfg + prosperity + age + logpop + uninsured,
                  lw, zero.policy = TRUE)
...
sr1a = errorsarlm(data = sr_data, retention ~ 0 + sr/(pct_ag + pct_mine + pct_mfg + logpop),
                  lw, zero.policy = TRUE)
sr1b = errorsarlm(data = sr_data, rrm_gap ~ 0 + sr/(pct_ag + pct_mine + pct_mfg + logpop),
                  lw, zero.policy = TRUE)
summary(sr1a)
summary(sr1b)
...
sr2a = errorsarlm(data = sr_data, prosperity ~ 0 + sr/(retention + rrm_gap  + pct_ag + pct_mine + pct_mfg + logpop),
                  lw, zero.policy = TRUE)

summary(sr2a)


sr2ai = errorsarlm(data = sr_data, prosperity ~ 0 + sr/(retention + rrm_gap + retention*rrm_gap + pct_ag + pct_mine + pct_mfg + logpop),
                  lw, zero.policy = TRUE)
...
sr2b = errorsarlm(data = sr_data, paam ~ 0 + sr/(retention + rrm_gap + pct_mfg + pct_ag + pct_mine + age + logpop + uninsured),
                  lw, zero.policy = TRUE)

summary(sr2b)


sr2bi = errorsarlm(data = sr_data, paam ~ 0 + sr/(retention + rrm_gap + retention*rrm_gap + pct_mfg + pct_ag + pct_mine + age + logpop + uninsured),
                  lw, zero.policy = TRUE)
...
sr3a = errorsarlm(data = sr_data, paam ~ 0 + sr/(retention + rrm_gap + retention*rrm_gap + pct_mfg + pct_ag + pct_mine + age + prosperity + logpop + uninsured),
                  lw, zero.policy = TRUE)

summary(sr3a)

sr3ai = errorsarlm(data = sr_data, paam ~ 0 + sr/(retention + rrm_gap + retention*rrm_gap + pct_mfg + pct_ag + pct_mine + age + prosperity + logpop + uninsured),
                  lw, zero.policy = TRUE)
...
sr1a = errorsarlm(data = sr_data, retention ~ 0 + sr2/(pct_ag + pct_mine + pct_mfg + logpop),
                  lw, zero.policy = TRUE)
sr1b = errorsarlm(data = sr_data, rrm_gap ~ 0 + sr2/(pct_ag + pct_mine + pct_mfg + logpop + metro),
                  lw, zero.policy = TRUE)
summary(sr1a)
summary(sr1b)
...
sr2a = errorsarlm(data = sr_data, prosperity ~ 0 + sr2/(retention + rrm_gap + pct_ag + pct_mine + pct_mfg + logpop),
                  lw, zero.policy = TRUE)

summary(sr2a)

sr2ai = errorsarlm(data = sr_data, prosperity ~ 0 + sr2/(retention + rrm_gap + retention*rrm_gap + pct_ag + pct_mine + pct_mfg + logpop),
                  lw, zero.policy = TRUE)
...
sr2b = errorsarlm(data = sr_data, paam ~ 0 + sr2/(retention + rrm_gap + pct_mfg + pct_ag + pct_mine + age + logpop + uninsured),
                  lw, zero.policy = TRUE)

summary(sr2b)

sr2bi = errorsarlm(data = sr_data, paam ~ 0 + sr2/(retention + rrm_gap + retention*rrm_gap + pct_mfg + pct_ag + pct_mine + age + logpop + uninsured),
                  lw, zero.policy = TRUE)
...
sr3a = errorsarlm(data = sr_data, paam ~ 0 + sr2/(retention + rrm_gap + pct_mfg + pct_ag + pct_mine + age + prosperity + logpop + uninsured),
                  lw, zero.policy = TRUE)
...
sr3ai = errorsarlm(data = sr_data, paam ~ 0 + sr2/(retention + rrm_gap + retention*rrm_gap + pct_mfg + pct_ag + pct_mine + age + prosperity + logpop + uninsured),
                  lw, zero.policy = TRUE)
...
sr1a = errorsarlm(data = sr_data, retention ~ 0 + sr3/(pct_ag + pct_mine + pct_mfg + logpop),
                  lw, zero.policy = TRUE)
sr1b = errorsarlm(data = sr_data, rrm_gap ~ 0 + sr3/(pct_ag + pct_mine + pct_mfg + logpop),
                  lw, zero.policy = TRUE)
summary(sr1a)
summary(sr1b)
...
sr2a = errorsarlm(data = sr_data, prosperity ~ 0 + sr3/(retention + rrm_gap +  pct_ag + pct_mine + pct_mfg + logpop),
                  lw, zero.policy = TRUE)

summary(sr2a)

sr2ai = errorsarlm(data = sr_data, prosperity ~ 0 + sr3/(retention + rrm_gap + retention*rrm_gap + pct_ag + pct_mine + pct_mfg + logpop),
                  lw, zero.policy = TRUE)
...
sr2b = errorsarlm(data = sr_data, paam ~ 0 + sr3/(retention + rrm_gap + pct_mfg + pct_ag + pct_mine + age + logpop + uninsured),
                  lw, zero.policy = TRUE)

summary(sr2b)

sr2bi = errorsarlm(data = sr_data, paam ~ 0 + sr3/(retention + rrm_gap + retention*rrm_gap + pct_mfg + pct_ag + pct_mine + age + logpop + uninsured),
                  lw, zero.policy = TRUE)
...
sr3a = errorsarlm(data = sr_data, paam ~ 0 + sr3/(retention + rrm_gap +  pct_mfg + pct_ag + pct_mine + age + prosperity + logpop + uninsured),
                  lw, zero.policy = TRUE)

summary(sr3a)


sr3ai = errorsarlm(data = sr_data, paam ~ 0 + sr3/(retention + rrm_gap + retention*rrm_gap + pct_mfg + pct_ag + pct_mine + age + prosperity + logpop + uninsured),
                  lw, zero.policy = TRUE)
