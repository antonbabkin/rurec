...
ols2a = lm(data = mi1, paam ~ retention_calc + autonomy_calc + pct_ag + pct_mine + pct_durable + pct_nondurable + laborforce_part_rate + age + highschool_attainment_rate + poverty_rate + income_rate + logpop + uninsured)
ols2b = lm(data = mi1, paam ~ retention_calc + pct_ag + pct_mine + pct_durable + pct_nondurable + laborforce_part_rate + age + highschool_attainment_rate + poverty_rate + income_rate + logpop + uninsured)
ols2c = lm(data = mi1, paam ~ retention_calc + pct_ag + pct_mine + pct_durable + pct_nondurable + laborforce_part_rate + age + highschool_attainment_rate + poverty_rate + income_rate + logpop + uninsured)
...
err2a = errorsarlm(data = mi1, paam ~ retention_calc + autonomy_calc + pct_durable + pct_nondurable + pct_ag + laborforce_part_rate + pct_mine + age + highschool_attainment_rate + poverty_rate + income_rate + logpop + uninsured,
                  lw, zero.policy = TRUE)
err2b = errorsarlm(data = mi1, paam ~ retention_calc + pct_durable + pct_nondurable + pct_ag + laborforce_part_rate + pct_mine + age + highschool_attainment_rate + poverty_rate + income_rate + logpop + uninsured,
                  lw, zero.policy = TRUE)
err2c = errorsarlm(data = mi1, paam ~ autonomy_calc + pct_durable + pct_nondurable + pct_ag + laborforce_part_rate + pct_mine + age + highschool_attainment_rate + poverty_rate + income_rate + logpop + uninsured,
                  lw, zero.policy = TRUE)
...
ols2a = lm(data = mi1, paam ~ retention_calc + autonomy_calc + retention_calc*pct_durable + retention_calc*pct_nondurable + retention_calc*pct_mine + retention_calc*pct_ag + autonomy_calc*pct_durable + autonomy_calc*pct_nondurable + autonomy_calc*pct_mine + autonomy_calc*pct_ag + pct_ag + pct_mine + pct_durable + pct_nondurable + laborforce_part_rate + age + highschool_attainment_rate + poverty_rate + income_rate + logpop + uninsured)

ols2b = lm(data = mi1, paam ~ retention_calc + retention_calc*pct_durable + retention_calc*pct_nondurable + retention_calc*pct_mine + retention_calc*pct_ag + pct_ag + pct_mine + pct_durable + pct_nondurable + laborforce_part_rate + age + highschool_attainment_rate + poverty_rate + income_rate + logpop + uninsured)

ols2c = lm(data = mi1, paam ~ autonomy_calc + autonomy_calc*pct_durable + autonomy_calc*pct_nondurable + autonomy_calc*pct_mine + autonomy_calc*pct_ag + pct_ag + pct_mine + pct_durable + pct_nondurable + laborforce_part_rate + age + highschool_attainment_rate + poverty_rate + income_rate + logpop + uninsured)
...
err2a = errorsarlm(data = mi1, paam ~ retention_calc + autonomy_calc + pct_durable + pct_nondurable + pct_mine + pct_ag + laborforce_part_rate + age + highschool_attainment_rate + poverty_rate + income_rate + logpop + uninsured + retention_calc*pct_ag + retention_calc*pct_durable + retention_calc*pct_nondurable + autonomy_calc*pct_durable + autonomy_calc*pct_nondurable + autonomy_calc*pct_ag,
                  lw, zero.policy = TRUE)

err2b = errorsarlm(data = mi1, paam ~ retention_calc + pct_durable + pct_nondurable + pct_mine + pct_ag + laborforce_part_rate + age + highschool_attainment_rate + poverty_rate + income_rate + logpop + uninsured + retention_calc*pct_durable + retention_calc*pct_nondurable + retention_calc*pct_mine + retention_calc*pct_ag,
                  lw, zero.policy = TRUE)

err2c = errorsarlm(data = mi1, paam ~ autonomy_calc + pct_durable + pct_nondurable + pct_mine + pct_ag + laborforce_part_rate + age + highschool_attainment_rate + poverty_rate + income_rate + logpop + uninsured + autonomy_calc*pct_durable + autonomy_calc*pct_nondurable + autonomy_calc*pct_mine + autonomy_calc*pct_ag,
                  lw, zero.policy = TRUE)
...
<!--                  xnames = c("pct_mfg", "pct_ag", "retention_calc", "logpop", "uninsured", "age", "laborforce_part_rate", "poverty_rate", "highschool_attainment_rate")) -->
<!-- ======= -->
<!--                  xnames = c("pct_mfg", "pct_ag", "pct_edmed", "retention_calc", "logpop", "uninsured", "age", "laborforce_part_rate", "poverty_rate", "highschool_attainment_rate")) -->
...
<!--                  xnames = c("pct_mfg", "pct_ag", "retention_calc", "logpop", "uninsured", "age", "laborforce_part_rate", "poverty_rate", "highschool_attainment_rate", "splagerr")) -->
<!-- ======= -->
<!--                  xnames = c("pct_mfg", "pct_ag", "pct_edmed", "retention_calc", "logpop", "uninsured", "age", "laborforce_part_rate", "poverty_rate", "highschool_attainment_rate", "splagerr")) -->
<!-- >>>>>>> bf38728ff4223f955701ebe8d7e1b33cb942b384 -->
<!-- >>>>>>> cc1ce359f717e7f0470da833cf96e9811c441b5b -->
