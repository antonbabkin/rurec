...
mi1 = df_map %>% drop_na(c(paam, retention_calc, pct_nondurable, pct_durable, pct_mine, pct_ag, pct_fire, pct_edmed, laborforce_part_rate, age, bach, poverty_rate, income_rate, logpop, uninsured))

ols2a = lm(data = mi1, paam ~ retention_calc + autonomy_calc + pct_ag + pct_mine + pct_durable + pct_nondurable + laborforce_part_rate + age + bach + poverty_rate + income_rate + logpop + uninsured)
ols2b = lm(data = mi1, paam ~ retention_calc + pct_ag + pct_mine + pct_durable + pct_nondurable + laborforce_part_rate + age + bach + poverty_rate + income_rate + logpop + uninsured)
ols2c = lm(data = mi1, paam ~ retention_calc + pct_ag + pct_mine + pct_durable + pct_nondurable + laborforce_part_rate + age + bach + poverty_rate + income_rate + logpop + uninsured)
...
err2a = errorsarlm(data = mi1, paam ~ retention_calc + autonomy_calc + pct_durable + pct_nondurable + pct_ag + laborforce_part_rate + pct_mine + age + bach + poverty_rate + income_rate + logpop + uninsured,
                  lw, zero.policy = TRUE)
err2b = errorsarlm(data = mi1, paam ~ retention_calc + pct_durable + pct_nondurable + pct_ag + laborforce_part_rate + pct_mine + age + bach + poverty_rate + income_rate + logpop + uninsured,
                  lw, zero.policy = TRUE)
err2c = errorsarlm(data = mi1, paam ~ autonomy_calc + pct_durable + pct_nondurable + pct_ag + laborforce_part_rate + pct_mine + age + bach + poverty_rate + income_rate + logpop + uninsured,
                  lw, zero.policy = TRUE)
...
model5 <- '
  ...
  autonomy_calc ~ pct_durable + pct_nondurable + pct_ag + pct_mine
  prosperity ~ pct_durable + pct_nondurable + pct_ag + pct_mine + a*retention_calc + x*autonomy_calc + logpop
  paam ~ logpop + uninsured + b*prosperity + pct_durable + pct_nondurable + pct_ag + pct_mine + c*retention_calc + z*autonomy_calc + age
...
model5 <- '
  ...
  autonomy_calc ~ pct_durable + pct_nondurable + pct_ag + pct_mine
  prosperity ~ pct_durable + pct_nondurable + pct_ag + pct_mine + x*autonomy_calc + logpop
  paam ~ logpop + uninsured + b*prosperity + pct_durable + pct_nondurable + pct_ag + pct_mine + z*autonomy_calc + age
...
ols2a = lm(data = mi1, paam ~ retention_calc + autonomy_calc + retention_calc*pct_durable + retention_calc*pct_nondurable + retention_calc*pct_mine + retention_calc*pct_ag + autonomy_calc*pct_durable + autonomy_calc*pct_nondurable + autonomy_calc*pct_mine + autonomy_calc*pct_ag + pct_ag + pct_mine + pct_durable + pct_nondurable + laborforce_part_rate + age + bach + poverty_rate + income_rate + logpop + uninsured)

ols2b = lm(data = mi1, paam ~ retention_calc + retention_calc*pct_durable + retention_calc*pct_nondurable + retention_calc*pct_mine + retention_calc*pct_ag + pct_ag + pct_mine + pct_durable + pct_nondurable + laborforce_part_rate + age + bach + poverty_rate + income_rate + logpop + uninsured)

ols2c = lm(data = mi1, paam ~ autonomy_calc + autonomy_calc*pct_durable + autonomy_calc*pct_nondurable + autonomy_calc*pct_mine + autonomy_calc*pct_ag + pct_ag + pct_mine + pct_durable + pct_nondurable + laborforce_part_rate + age + bach + poverty_rate + income_rate + logpop + uninsured)
...
err2a = errorsarlm(data = mi1, paam ~ retention_calc + autonomy_calc + pct_durable + pct_nondurable + pct_mine + pct_ag + laborforce_part_rate + age + bach + poverty_rate + income_rate + logpop + uninsured + retention_calc*pct_ag + retention_calc*pct_durable + retention_calc*pct_nondurable + autonomy_calc*pct_durable + autonomy_calc*pct_nondurable + autonomy_calc*pct_ag,
                  lw, zero.policy = TRUE)

err2b = errorsarlm(data = mi1, paam ~ retention_calc + pct_durable + pct_nondurable + pct_mine + pct_ag + laborforce_part_rate + age + bach + poverty_rate + income_rate + logpop + uninsured + retention_calc*pct_durable + retention_calc*pct_nondurable + retention_calc*pct_mine + retention_calc*pct_ag,
                  lw, zero.policy = TRUE)

err2c = errorsarlm(data = mi1, paam ~ autonomy_calc + pct_durable + pct_nondurable + pct_mine + pct_ag + laborforce_part_rate + age + bach + poverty_rate + income_rate + logpop + uninsured + autonomy_calc*pct_durable + autonomy_calc*pct_nondurable + autonomy_calc*pct_mine + autonomy_calc*pct_ag,
                  lw, zero.policy = TRUE)
...
model5 <- '
  ...
  retention_calc ~ pct_durable + pct_nondurable + pct_ag + pct_mine
  autonomy_calc ~ pct_durable + pct_nondurable + pct_ag + pct_mine
  prosperity ~ pct_durable + pct_nondurable + pct_ag + pct_mine + a*retention_calc + x*autonomy_calc + logpop + retention_calc:pct_durable + retention_calc:pct_nondurable + retention_calc:pct_ag + autonomy_calc:pct_durable + autonomy_calc:pct_nondurable + autonomy_calc:pct_ag
  paam ~ logpop + uninsured + b*prosperity + pct_durable + pct_nondurable + pct_ag + pct_mine + c*retention_calc + z*autonomy_calc + age
...
model5 <- '
  ...
  autonomy_calc ~ pct_durable + pct_nondurable + pct_ag + pct_mine
  prosperity ~ pct_durable + pct_nondurable + pct_ag + pct_mine + x*autonomy_calc + logpop + autonomy_calc:pct_durable + autonomy_calc:pct_nondurable + autonomy_calc:pct_ag
  paam ~ logpop + uninsured + b*prosperity + pct_durable + pct_nondurable + pct_ag + pct_mine + z*autonomy_calc + age
...
<!-- ols1 = lm(data = df_map, paam ~ retention_calc + pct_ag + pct_mine + pct_mfg + laborforce_part_rate + age + bach + poverty_rate + income_rate + logpop + uninsured) -->

<!-- ols2 = lm(data = df_map, paam ~ retention_calc + retention_calc*pct_mfg + retention_calc*pct_mine + retention_calc*pct_ag + pct_ag + pct_mine + pct_mfg + laborforce_part_rate + age + bach + poverty_rate + income_rate + logpop + uninsured) -->
...
<!-- err1 = errorsarlm(data = mi1, paam ~ retention_calc + pct_ag + pct_mine + pct_mfg + laborforce_part_rate + age + bach + poverty_rate + income_rate + logpop + uninsured, -->
<!--                   lw, zero.policy = TRUE) -->

<!-- err2 = errorsarlm(data = mi1, paam ~ retention_calc + retention_calc*pct_mfg + retention_calc*pct_mine + retention_calc*pct_ag + pct_ag + pct_mine + pct_mfg + laborforce_part_rate + age + bach + poverty_rate + income_rate + logpop + uninsured, -->
<!--                   lw, zero.policy = TRUE) -->
...
<!-- ols1 = lm(data = mi1, paam ~ retention_calc + pct_ag + pct_mine + pct_mfg + laborforce_part_rate + age + bach + poverty_rate + income_rate + logpop + uninsured) -->
<!-- ols3 = lm(data = mi1, paam ~ autonomy_calc + pct_ag + pct_mine + pct_mfg + laborforce_part_rate + age + bach + poverty_rate + income_rate + logpop + uninsured) -->
