...
## south/nonsouth, metro/nonmetro

```{r}

sr_data2 = mi1 %>% mutate(rucc = as.numeric(ruc_code), sr = metro_nonmetro, sr2 = ifelse((rucc == 1 | rucc == 2), "large.metro",
        ifelse((rucc == 3), "small.metro",                                       ifelse((rucc >= 4), "nonmetro", NA))),
sr3 = ifelse((rucc == 1 | rucc == 2), "large.metro",
       ifelse((rucc == 3), "small.metro",                                       ifelse((rucc == 4 | rucc == 5), "large.nonmetro",
       ifelse((rucc >= 6), "small.nonmetro", NA))))) %>%
  mutate(south = ifelse((state == "05" | state == "22" | state == "28" | state == "47" | state == "21" | state == "01" | state == "54" | state == "51" | state == "13" | state == "37" | state == "45" | state == "12"), 1, 0))
...
sr1b = errorsarlm(data = sr_data2, rrm_gap ~ 0 + sr/(pct_ag + pct_mine + pct_mfg + logpop + pct_black + pct_hisp + pct_ind + south),
                  lw, zero.policy = TRUE)
summary(sr1b)
...
sr2a = errorsarlm(data = sr_data2, prosperity ~ 0 + sr/(retention + rrm_gap + pct_black + pct_hisp + pct_ind  + pct_ag + pct_mine + pct_mfg + logpop + south),
                  lw, zero.policy = TRUE)

summary(sr2a)


sr2ai = errorsarlm(data = sr_data2, prosperity ~ 0 + sr/(retention + rrm_gap + south + pct_black + pct_hisp + pct_ind + pct_ag + pct_mine + pct_mfg + logpop + retention*rrm_gap + south*retention + south*retention*rrm_gap),
                  lw, zero.policy = TRUE)
...
sr2b = errorsarlm(data = sr_data2, paam ~ 0 + sr/(retention + rrm_gap + pct_black + pct_hisp + pct_ind + pct_mfg + pct_ag + pct_mine + age + logpop + uninsured + south),
                  lw, zero.policy = TRUE)

summary(sr2b)


sr2bi = errorsarlm(data = sr_data2, paam ~ 0 + sr/(retention + rrm_gap + pct_black + pct_hisp + pct_ind + pct_mfg + pct_ag + pct_mine + age + logpop + uninsured + south + retention*rrm_gap + south*retention + south*retention*rrm_gap),
                  lw, zero.policy = TRUE)
...
sr3a = errorsarlm(data = sr_data2, paam ~ 0 + sr/(retention + rrm_gap + pct_black + pct_hisp + pct_ind + pct_mfg + pct_ag + pct_mine + age + prosperity + logpop + uninsured + south),
                  lw, zero.policy = TRUE)

summary(sr3a)

sr3ai = errorsarlm(data = sr_data2, paam ~ 0 + sr/(retention + rrm_gap + pct_black + pct_hisp + pct_ind + pct_mfg + pct_ag + pct_mine + age + prosperity + logpop + uninsured + south + retention*rrm_gap + south*retention + south*retention*rrm_gap),
                  lw, zero.policy = TRUE)
...
sr_data_temp = mi1 %>% mutate(rucc = as.numeric(ruc_code), sr = metro_nonmetro, sr2 = ifelse((rucc == 1 | rucc == 2), "large.metro",
        ifelse((rucc == 3), "small.metro",                                       ifelse((rucc >= 4), "nonmetro", NA))),
sr3 = ifelse((rucc == 1 | rucc == 2), "large.metro",
       ifelse((rucc == 3), "small.metro",                                       ifelse((rucc == 4 | rucc == 5), "large.nonmetro",
       ifelse((rucc >= 6), "small.nonmetro", NA)))))
...
```{r}
cca4 = cca3
cca4$sr3 <- factor(cca3$sr3, levels = c("large.metro", "small.metro", "large.nonmetro", "small.nonmetro"))
