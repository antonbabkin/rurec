...
>>>>>>> 58dc4636e6493ffd703c20c501a7c0831c652850
...
data %>% select(prosperity, laborforce_part_rate, age, bach, poverty_rate, income_rate, logpop, uninsured) %>% hist.data.frame()
...
df_map <- left_join(map, data, by = "place") %>% 
  drop_na(paam, ypll75, retention, autonomy, prosperity, emp_to_va, emp_to_output, va_to_output)
