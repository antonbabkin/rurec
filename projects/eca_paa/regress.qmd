...
params:
  ...
  reg_factors: !expr c("gross_output", "population", "employment", "jobs", "laborforce_part_rate", "unemp_rate", "payroll", "wage", "income_rate", "establishments", "entry_rate", "exit_rate", "poverty_rate", "ypll75", "highschool_attainment_rate", "net_migration_rate")
  reg_factor_funs: !expr c("call_gross_output","call_population", "call_employment","call_unemp_rate", "call_laborforce_rate", "call_jobs", "call_establishments", "call_payroll", "call_wage", "call_exit_rate", "call_entry_rate", "call_income_rate", "call_poverty_rate", "call_ypll75", "call_highschool_attainment_rate", "call_net_migration")
