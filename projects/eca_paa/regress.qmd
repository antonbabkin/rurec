...
# for (i in  c("establishment_gr", "wage_gr", "employment_gr", "payroll_gr")){
#   tmp <- tmp %>% 
#     mutate(tmp[[i]] = ifelse(tmp[[i]] == 200, NA, ifelse(tmp[[i]] == -200, NA, tmp[[i]]))) 
# }
}
# eval(paste0(substring(i, 6), "_grow_rate")) 
# params$reg_factor_funs
```
