...
dl <- list(
  ...
  dp$call_jobs(year = params$year, bus_data = "cbp_imp"), 
  dp$call_gross_output(year = params$year, bus_data = "cbp_imp"),
  dp$call_intermediate_supply(year = params$year, bus_data = "cbp_imp"),
  dp$call_intermediate_demand(year = params$year, bus_data = "cbp_imp"),
  dp$call_net_supply(year = params$year, bus_data = "cbp_imp"),
  dp$call_net_demand(year = params$year, bus_data = "cbp_imp"),
  dp$call_laborforce_rate(year = params$year, bus_data = "tidy_acs"),
  dp$call_income(year = params$year, bus_data = "bea_profile"),
  dp$call_income_rate(year = params$year, bus_data = "bea_profile"),
  dp$call_highschool_attainment_rate(year = params$year, bus_data = "tidy_acs"),
  dp$call_poverty(year = params$year, bus_data = "saipe"),
  dp$call_poverty_rate(year = params$year, bus_data = "saipe"),
  dp$call_gdp(year = params$year, bus_data = "bea_rea"),
  dp$call_ypll75(year = params$year, bus_data = "chr"),
  dp$call_establishments(year = params$year, bus_data = "cbp_raw"),
