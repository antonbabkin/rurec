...
MyPalette <- c("#97c08d", "#3d85c6", "gold", "grey")
...
print(comp_map %>%
  tm_shape() + 
  tm_polygons(col = "comp", title = "County Centrality, ECAs & CBSAs", border.alpha = 0.0, style = "cat", palette = MyPalette) +
  tm_layout(legend.title.size = 1.0, legend.position = c("left","bottom")))
