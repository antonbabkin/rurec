...
```{r}
dp$call_cbsa_conc(2013) |> head()
dp$call_cbsa_delin_df(2013) |> head()
```
...
# TODO: growth calculation throws an error
...
# TODO: growth calculation throws an error
# dp$growth_rate(2012, 2017, dp$call_income_rate) |> head()
```
