...
df_bds_met <- pubdata::bds_get("2022_met") %>%
  mutate(rural = case_match(metro, "M" ~ "metro", "N" ~ "non-metro"))

df_bds_met_eac <- pubdata::bds_get("2022_met_eac") %>%
  mutate(rural = case_match(metro, "M" ~ "metro", "N" ~ "non-metro"))

df_bds_met_ezc <- pubdata::bds_get("2022_met_ezc") %>%
  mutate(rural = case_match(metro, "M" ~ "metro", "N" ~ "non-metro"))

df_bds_met_sec <- pubdata::bds_get("2022_met_sec") %>%
  mutate(rural = case_match(metro, "M" ~ "metro", "N" ~ "non-metro"))
...
df_bds_st_cty <- pubdata::bds_get("2022_st_cty")
